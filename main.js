...
// "творчеством" :)
// 
// Код запускал через расширение для VS Code - Live Server
// Если открывать через file:// а не http://, то в константу
// leadsResponseResult надо поместить json ответа, я же его вынес
// в отдельный файл для удобства
// ------------------------------------------------------------------
